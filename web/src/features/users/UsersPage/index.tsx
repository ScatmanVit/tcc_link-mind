...
// Dados de exemplo para substituir chamadas de API
const initialUsers = [
...
export default function UsersPage() {
  ...
  const [actionUser, setActionUser] = useState<User | null>(null) // Estado para o modal de ações
  ...
  // Função para fechar os modais de edição/criação/email
  const closeSubModal = () => {
    setIsCreating(false)
    setEditingUser(null)
    setUserToEmail(null)
  ...
  return (
    <div className="container">
      ...
      <ActionsModal
        user={actionUser}
        onClose={() => setActionUser(null)} // Apenas fecha o modal de ações
