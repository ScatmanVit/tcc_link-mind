...
export default function LinksIndex() {
   ...
   */
   ...
   // ISSO AQUI VAI FUNCIONAR QUANDO EU TIVER O OBJETO DA API DAS CATEGORIAS DO USUÁRIO, FALTA FAZER NA API OS ENDPOINTS
   // useEffect(() => {
   //    if (selectedCategory != "Todas") {
   //       setLinksFiltered(links
   //          .filter(links => links.categoryId === selectedCategory.id)
   //       )
   //    } else {
